...
def _face_detect(opencv_image, config='haarcascade_frontalface_default'):
    ...
    haar_cascade = cv.Load('/home/ami/AmI-Platform/resources/opencv_detectors/%s' % config)
...
def voting_face_detect(image, delta = 20):
    ...
    """
    configs = [config for config in listdir("/home/ami/AmI-Platform/resources/opencv_detectors")]
