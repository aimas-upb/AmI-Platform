...
#
#         0.6x 15.07.2011  Octavian Voicu <octavian.voicu@gmail.com>
#                          - add AVRDUDE_ARD_EXTRA_OPTS
#                          - ignore missing dep file
#                          - also build .c, .cc, .S files in libraries
#                          - allow overriding ARDUINO_LIB_PATH
#
########################################################################
#
...
ARDUINO_ETC_PATH  = $(AVR_TOOLS_PATH)
endif
...
ifndef AVRDUDE_ARD_EXTRA_OPTS
AVRDUDE_ARD_EXTRA_OPTS =
endif
...
ifndef CORE
CORE = $(shell $(PARSE_BOARD) $(BOARD_TAG) build.core)
endif
...
ARDUINO_CORE_PATH = $(ARDUINO_DIR)/hardware/arduino/cores/$(CORE)
...
LIB_CC_SRCS   = $(wildcard $(patsubst %,%/*.cc,$(SYS_LIBS)))
LIB_AS_SRCS   = $(wildcard $(patsubst %,%/*.S,$(SYS_LIBS)))
LIB_OBJ_FILES = $(LIB_C_SRCS:.c=.o) $(LIB_CPP_SRCS:.cpp=.o) \
		$(LIB_CC_SRCS:.cc=.o) $(LIB_AS_SRCS:.S=.o)
LIB_OBJS      = $(patsubst $(ARDUINO_LIB_PATH)/%,$(OBJDIR)/libs/%,$(LIB_OBJ_FILES))
...
$(OBJDIR)/libs/%.o: $(ARDUINO_LIB_PATH)/%.cc
	mkdir -p $(dir $@)
	$(CXX) -c $(CPPFLAGS) $(CXXFLAGS) $< -o $@
...
AVRDUDE_ARD_OPTS = -c $(AVRDUDE_ARD_PROGRAMMER) -b $(AVRDUDE_ARD_BAUDRATE) -P $(ARD_PORT) $(AVRDUDE_ARD_EXTRA_OPTS)
