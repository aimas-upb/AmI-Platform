...
class RoomPositionTest(TestCase):
    ...
    def run_with(self, track_event, sensor_pos, torso_pos, 
        ...
        track_event.assert_any_call('test:room-position', 1, PositionMatcher(expected_x,
                                                                   expected_y,
                                                                   expected_z,
                                                                   expected))
